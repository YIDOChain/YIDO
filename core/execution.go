...
import (
	...
	"github.com/yido/yido-chain/core/state"
	"github.com/yido/yido-chain/core/vm"
	"github.com/yido/yido-chain/crypto"
	"github.com/yido/yido-chain/params"
)
...
func (self *Execution) exec(contextAddr *common.Address, code []byte, caller vm.ContextRef) (ret []byte, err error) {
	...
	ret, err = yidovm.Run(context, self.input)
	if err != nil {
